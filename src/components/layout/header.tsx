...
import { Menu, Users, Briefcase, Star, HelpCircle } from 'lucide-react';
import {
  NavigationMenu,
      ...
      <div className="container flex h-16 items-center">
        <div className="hidden md:flex justify-start flex-1">
           <Link href="/" className="flex items-center space-x-2">
            <Image src="https://media.discordapp.net/attachments/1386576152503652472/1413874366982258829/Cred_Able_1.png?ex=68c6bf1d&is=68c56d9d&hm=d9a52cd4b2a5ec705c69431feccb397810761b0c250875b23fa1558c6108a92a&=&format=webp&quality=lossless&width=625&height=625" alt="CredAble Logo" width={64} height={64} />
