...
const Logos = ({
  ...
  logos = [
    ...
    { id: 'logo-5', description: 'Casey Neistat', image: 'https://i.ytimg.com/vi/_I_8P9jgZQs/maxresdefault.jpg', followers: '12.5M', platform: 'YouTube', className: "h-16 w-16 rounded-full" },
