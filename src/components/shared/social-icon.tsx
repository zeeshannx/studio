  ...
  switch (platform) {
    ...
    case 'TikTok':
      return (
        ...
        >
            <defs>
                <linearGradient id="tiktok-gradient-1" x1="0" y1="0" x2="0" y2="100%">
                 ...
                 <filter id="tiktok-shadow">
                    ...
                    <feFlood floodColor="#FF004F" floodOpacity="0.5"/>
            ...
            <g>
                <path d="M12.53.02C13.84 0 15.14.01 16.44 0c.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-2.43.05-4.84-.95-6.43-2.8-1.59-1.87-2.15-4.14-1.71-6.42.4-2.04 1.89-3.83 3.8-4.73 2.06-.98 4.34.13 5.71 1.84.05.06.09.13.14.19.13.15.24.32.39.46v-3.4c-.01-2.92.01-5.83.01-8.75z" fill="#FF004F" style={{mixBlendMode: 'lighten'}}/>
