    ...
    case 'TikTok':
       return (
        <svg
          ...
          {...props}
        >
          <path fill="#ff0050" d="M22.95,9.65c-0.12,2.37-1.34,4.55-3.2,5.93c-1.86,1.38-4.24,1.8-6.42,1.14v7.26c0.01,1.6-0.66,3.13-1.85,4.2c-1.19,1.07-2.79,1.59-4.4,1.48c-2.31-0.15-4.43-1.43-5.59-3.41c-1.16-1.98-1.2-4.44-0.1-6.48c1.1-2.04,3.21-3.41,5.55-3.62c0.28-0.02,0.56-0.04,0.84-0.04c0.55,0,1.09,0.08,1.6,0.25v-7.5c-0.21-0.08-0.42-0.16-0.64-0.23c-2.5-0.86-4.52-2.67-5.7-5.02C2.7,2.71,2.94,0.1,5.33,0.01c0.02,0,0.05,0,0.07,0c2.5,0,4.8,1.48,5.91,3.75c0.75,1.52,0.95,3.22,0.61,4.86c-0.06,0.3-0.13,0.59-0.21,0.88c-0.28,1-0.5,2-0.64,3.01H22.95z"></path>
          <path fill="#00f2ea" d="M22.95,9.65v7.38c-2.04,0.52-4.23,0.13-6.05-1.07c-1.81-1.2-2.92-3.14-3.05-5.26c-0.12-2.37,1.34-4.55,3.2-5.93c1.86-1.38,4.24-1.8,6.42-1.14c0.5,0.15,0.96,0.38,1.38,0.67V2.13c-0.45-0.23-0.93-0.4-1.42-0.5c-2.5-0.5-5.06,0.34-6.8,2.2c-1.74,1.86-2.4,4.5-1.7,7.02c0.7,2.52,2.95,4.3,5.54,4.45c0.41,0.02,0.82,0.02,1.23,0c2.23-0.14,4.25-1.42,5.36-3.32c0.16-0.27,0.3-0.56,0.42-0.85c0.08-0.2,0.15-0.4,0.21-0.6c0.02-0.08,0.04-0.15,0.06-0.23c0.11-0.41,0.19-0.82,0.24-1.24H22.95z"></path>
          <path fill="#FFFFFF" d="M16.9,15.91c-1.81-1.2-2.92-3.14-3.05-5.26c-0.12-2.37,1.34-4.55,3.2-5.93c1.86-1.38,4.24-1.8,6.42-1.14c0.5,0.15,0.96,0.38,1.38,0.67V2.13c-0.45-0.23-0.93-0.4-1.42-0.5c-2.5-0.5-5.06,0.34-6.8,2.2c-1.74,1.86-2.4,4.5-1.7,7.02c0.7,2.52,2.95,4.3,5.54,4.45c0.41,0.02,0.82,0.02,1.23,0c0.15-0.01,0.3-0.02,0.45-0.04v-2.19c-0.14,0.01-0.28,0.02-0.42,0.02C17.76,15.98,17.33,15.96,16.9,15.91z"></path>
        </svg>
      );
    case 'Snapchat':
        return (
