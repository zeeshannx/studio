...
export interface DetailedTalent extends TalentType {
    ...
    appliedFor?: string;
    aiMatch?: number;
    applicationStatus?: 'Viewed' | 'In Review' | 'Rejected' | 'Hired';
    interviewStatus?: 'Scheduled' | 'Completed' | 'Pending';
    verificationBadge?: 'Diamond' | 'Gold' | 'Silver';
}
...
export const allTalents: DetailedTalent[] = [
    ...
    { 
        src: 'https://picsum.photos/seed/tt2/64/64', 
        name: 'Thomas Beer', 
        role: 'Channel Manager', 
        platform: 'Twitch', 
        bio: 'Experienced Twitch Channel Manager, skilled in community engagement, stream production, and creator collaborations. Ready to grow your channel.', 
        vouches: 2, 
        status: 'Active', 
        location: 'Austin, TX', 
        appliedFor: 'Community Manager for Twitch & Discord',
        aiMatch: 88,
        applicationStatus: 'In Review',
    ...
    { 
        src: 'https://picsum.photos/seed/tt3/64/64', 
        name: 'Walker', 
        role: 'Thumbnail Designer', 
        platform: 'Instagram', 
        bio: 'Specializing in click-worthy thumbnail designs that boost CTR. Proficient in Photoshop and current with all Instagram trends.', 
        vouches: 0, 
        status: 'On Hold', 
        location: 'London, UK', 
    ...
    { 
        src: 'https://picsum.photos/seed/tt4/64/64', 
        name: 'Neox', 
        role: 'Thumbnail Designer', 
        platform: 'TikTok', 
        bio: 'Creative Thumbnail Designer for TikTok, focused on creating viral, eye-catching visuals that stop the scroll. Let\'s make your content pop.', 
        vouches: 0, 
        status: 'Active', 
        location: 'Berlin, DE', 
        appliedFor: 'Thumbnail Designer',
    ...
    { 
        src: 'https://picsum.photos/seed/tt6/64/64', 
        name: 'Hald', 
        role: 'Thumbnail Designer', 
        platform: 'Facebook', 
        bio: 'Results-driven Thumbnail Designer for Facebook content. I create compelling visuals that increase engagement and drive traffic.', 
        vouches: 0, 
        status: 'Rejected', 
        location: 'Sydney, AU', 
        appliedFor: 'Thumbnail Designer',
    ...
    { 
        src: 'https://picsum.photos/seed/tt7/64/64', 
        name: 'TKG', 
        role: 'Thumbnail Designer', 
        platform: 'YouTube', 
        bio: 'YouTube Thumbnail specialist with a proven track record of increasing view counts through compelling and high-quality design.', 
        vouches: 8, 
        status: 'Active', 
        location: 'Tokyo, JP', 
        appliedFor: 'Thumbnail Designer',
    ...
    { 
        src: 'https://picsum.photos/seed/tt9/64/64', 
        name: 'Dimcha', 
        role: 'Thumbnail Designer', 
        platform: 'X', 
        bio: 'I design impactful thumbnails for X (formerly Twitter) that capture attention and communicate your message effectively in a crowded feed.', 
        vouches: 0, 
        status: 'Active', 
        location: 'Remote', 
        appliedFor: 'Thumbnail Designer',
    ...
    { 
        src: 'https://picsum.photos/seed/tt10/64/64', 
        name: 'Laura Chen', 
        role: 'Social Media Manager', 
        platform: 'Instagram', 
        bio: 'I help brands grow their Instagram presence through strategic content and community management. Let\'s create something beautiful together.', 
        vouches: 3, 
        status: 'On Hold', 
        location: 'Paris, FR', 
    ...
    { 
        src: 'https://picsum.photos/seed/tt11/64/64', 
        name: 'David Lee', 
        role: 'Podcast Producer', 
        platform: 'YouTube', 
        bio: 'From audio engineering to content strategy, I produce high-quality podcasts that captivate listeners and build loyal audiences on YouTube.', 
        vouches: 0, 
        status: 'Active', 
        location: 'Toronto, CA', 
        appliedFor: 'Podcast Producer & Audio Engineer',
        aiMatch: 91,
        applicationStatus: 'In Review',
        interviewStatus: 'Scheduled',
        platforms: ['YouTube'],
    ...
    { 
        src: 'https://picsum.photos/seed/tt12/64/64', 
        name: 'Aisha Khan', 
        role: 'UGC Content Creator', 
        platform: 'TikTok', 
        bio: 'Specializing in authentic and engaging user-generated style content for TikTok. I help brands connect with Gen Z.', 
        vouches: 0, 
        status: 'Rejected', 
        location: 'Dubai, AE', 
    ...
    { 
        src: 'https://picsum.photos/seed/tt13/64/64', 
        name: 'Markus Black', 
        role: 'Discord Community Moderator', 
        platform: 'Discord', 
        bio: 'Building safe, active, and engaging communities on Discord. Experienced in moderation, event planning, and bot management.', 
        vouches: 21, 
        status: 'Active', 
        location: 'Remote', 
        appliedFor: 'Community Manager for Twitch & Discord',
    ...
    { 
        src: 'https://picsum.photos/seed/tt15/64/64', 
        name: 'Jin Park', 
        role: 'Short-form Video Editor', 
        platform: 'Snapchat', 
        bio: 'Expert in creating fast-paced, attention-grabbing videos for Snapchat Spotlight and other short-form platforms.', 
        vouches: 0, 
        status: 'Active', 
        location: 'Seoul, KR', 
        appliedFor: 'Shorts Editor',
    ...
    { 
        src: 'https://picsum.photos/seed/tt16/64/64', 
        name: 'Wes', 
        role: 'Video Editor', 
        platform: 'YouTube', 
        bio: 'Versatile video editor with experience in long-form and short-form content across multiple platforms.', 
        vouches: 5, 
        status: 'Active', 
    ...
    { 
        src: 'https://picsum.photos/seed/tt17/64/64', 
        name: 'Rubi', 
        role: 'YouTube Strategist', 
        platform: 'YouTube', 
        bio: 'Data-driven YouTube strategist helping channels optimize for growth and revenue.', 
        vouches: 0, 
        status: 'On Hold', 
    ...
    { 
        src: 'https://picsum.photos/seed/tt18/64/64', 
        name: 'Craftify Productions', 
        role: 'Creative Director', 
        platform: 'YouTube', 
        bio: 'Full-service creative production house for ambitious YouTube channels.', 
        vouches: 1, 
        status: 'Active', 
        location: 'Remote', 
        appliedFor: 'Creative Director',
    ...
    { 
        src: 'https://picsum.photos/seed/tt19/64/64', 
        name: 'Amagi Productions', 
        role: 'Video Editor', 
        platform: 'YouTube', 
        bio: 'Specializing in cinematic and documentary-style video editing for YouTubers.', 
        vouches: 0, 
        status: 'Rejected', 
        location: 'Remote', 
        appliedFor: 'Senior Video Editor for MrBeast',
    ...
    { 
        src: 'https://picsum.photos/seed/tt20/64/64', 
        name: 'Vuk Sretenovic', 
        role: 'Video Editor', 
        platform: 'YouTube', 
        bio: 'Video editor with a knack for viral, meme-worthy content.', 
        vouches: 0, 
        status: 'Active', 
    ...
    { 
        src: 'https://picsum.photos/seed/tt21/64/64', 
        name: 'Pat Gostek', 
        role: 'YouTube Strategist', 
        platform: 'YouTube', 
        bio: 'Helping creators build sustainable careers on YouTube through smart strategy.', 
        vouches: 9, 
        status: 'Active', 
        location: 'Warsaw, PL', 
        appliedFor: 'Content Strategist',
